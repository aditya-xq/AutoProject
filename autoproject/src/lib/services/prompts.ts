...
const typeSpecificInstructions: Record<UserStoryType, string> = {
  Technical:
    'focused on architecture, APIs, storage design, integration contracts, and implementation detail',
  ...
  Research:
    'focused on research milestones, methodology rigor, evidence collection, and analysis tasks',
}
