<div class="bg-gradient-to-br from-black to-gray-900 text-gray-100 min-h-screen flex flex-col px-60 py-6 space-y-8">
    ...
    <div class="space-y-4 max-w-5xl">
        <h2 class="text-xl font-semibold text-blue-400">🚀 Getting Started</h2>
        <p>
    ...
    <!-- Fun Outro -->
    <div class="space-y-4 max-w-5xl">
        <h2 class="text-xl font-semibold text-yellow-400">🎯 Hit the Bullseye</h2>
        <p>
    ...
    <!-- Feedback Section -->
    <div class="space-y-4 max-w-5xl">
        <h2 class="text-xl font-semibold text-pink-400">💬 We Want Your Feedback!</h2>
        <p>
