...
<svelte:head>
    ...
    <title>AutoProject UI</title>
    <meta charset="UTF-8">
</svelte:head>

<nav class="fixed top-0 left-0 h-screen w-60 bg-gradient-to-b from-gray-900 to-black text-gray-100 flex flex-col items-center py-8 space-y-6">
    <!-- Brand Header -->
    <a href="/" class="flex items-center space-x-2">
        <span class="text-2xl">🚀</span>
        <h1 class="text-2xl font-bold text-purple-400">AutoProject</h1>
    </a>
    <div class="flex-grow w-full flex flex-col mt-10 space-y-4">
